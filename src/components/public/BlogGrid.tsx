            ...
            >
              ...
              >
                ...
                <div style={{ padding: '22px 22px 24px', display: 'flex', flexDirection: 'column', gap: 10, flex: 1 }}>
                  <div style={{ fontFamily: 'var(--font-mono)', fontSize: 11, color: 'var(--fg-mute)', letterSpacing: '0.06em' }}>
                  ...
                  <p style={{ color: 'var(--fg-dim)', fontSize: 14, lineHeight: 1.55, flex: 1, margin: 0 }}>
                    {t(post.excerpt, lang)}
                  </p>
                  {/* Read link */}
                  <div
                  ...
                  >
                    <span style={{ display: 'inline-block', width: 18, height: 1, background: 'var(--accent-spark)' }} />
                    {lang === 'de' ? 'Lesen' : 'Read'}
                  </div>
                </div>
              </article>
